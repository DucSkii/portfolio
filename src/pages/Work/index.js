...
const Work = () => {
  ...
  const socialMediaProject = {
    ...
    description: 'My social media app updates real time with a fully functional back-end. The website is also full responsive and users can personalise their themes. Other features include options to follow users, like posts, comment, real-time chat between users.',
    time: '3 weeks',
